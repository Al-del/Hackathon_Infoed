...
class show_data : ComponentActivity() {
   ...
   setContent {
    ...
    "Metal melting" to Pair(R.drawable.metal_melting, "Heat Protection: Wear heat-resistant gloves and eye protection.\nProper Ventilation: Melting metals can release fumes; ensure good ventilation."),
    ...
    "Mudification with Ash" to Pair(R.drawable.mudification_with_ash, "Respiratory Protection: Wear masks to avoid inhaling ash particles.\nSkin Protection: Use gloves to prevent skin irritation."),
